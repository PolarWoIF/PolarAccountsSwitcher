...
Thank you for contributing to the PolarWolves! If you have any questions or doubts, don't be afraid to send them my way. I appreciate all contributions, and I am looking forward to fostering an open, transparent, and collaborative environment.

Before contributing, I encourage you to also read or [LICENSE](https://discord.gg/PLR/blob/master/LICENSE), also found in this repository. If you have any inquiries or questions not answered by the content of this repository, feel free to [join the Discord](https://discord.gg/PLR) and ask in `#general-acc-switcher` under `POLARWOLVES ACCOUNT SWITCHER`.
...
See: [Building from source code](https://discord.gg/PLR/wiki/Building-from-source-code) in the project's Wiki.
