...
namespace PolarWolves_Globals
{
    public partial class Globals
    {
        ...
        public static string ExpandEnvironmentVariables(string path)
        {
            ...
            {
                { "%POLARWOLVES_UserData%", Globals.UserDataFolder },
                { "%POLARWOLVES_AppData%", Globals.AppDataFolder },
        ...
        private static readonly HttpClient HClient = BuildHttpClient();

        private static HttpClient BuildHttpClient()
        {
            var client = new HttpClient();
            // Configure once to avoid mutating shared headers during parallel downloads.
            _ = client.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "PolarWolves");
            return client;
        }
