;PolarWolves
;Wesley Pyburn (PolarWolves Team)
;https://github.com/PolarWolvesco/PolarWolves
...
!define APP_NAME "Polar Account Switcher"
!define LNK_NAME "Polar Account Switcher.lnk"
!define COMP_NAME "PolarWolves Team (Wesley Pyburn)"
!define WEB_SITE "https://discord.gg/PLR"
!define VERSION "2025.11.20.03"
!define DISPLAY_VERSION "2025-11-20_03"
!define COPYRIGHT "PolarWolves Team (Wesley Pyburn) (C) 2024"
!define DESCRIPTION "Polar Account Switcher"
!define LICENSE_TXT "..\..\docs\legal\LICENSE.txt"
!define PRIVACY_TXT "..\..\docs\legal\PRIVACY.txt"
!define MAIN_APP_EXE "PolarWolves.exe"
!define INSTALL_TYPE "SetShellVarContext current"
!define REG_ROOT "HKCU"
!define REG_APP_PATH "Software\Microsoft\Windows\CurrentVersion\App Paths\${MAIN_APP_EXE}"
!define UNINSTALL_EXE "Uninstall Polar Account Switcher.exe"
!define UNINSTALL_LNK_NAME "Uninstall Polar Account Switcher.lnk"
!define UNINSTALL_PATH "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}"
!define FIRST_RUN_EXE "_First_Run_Installer.exe"
!ifndef INSTALLER_ICON
!define INSTALLER_ICON "img\icon.ico"
!endif
!ifndef INSTALLER_HEADER_BMP
!define INSTALLER_HEADER_BMP "img\HeaderImage.bmp"
!endif
!ifndef INSTALLER_SIDEBANNER_BMP
!define INSTALLER_SIDEBANNER_BMP "img\SideBanner.bmp"
!endif

!define REG_START_MENU "Start Menu Folder"
!define SM_Folder "Polar Account Switcher"
...
!define INSTALL_DIR "$PROGRAMFILES64\Polar Account Switcher"
;;;;!define INSTALL_DIR "$PROGRAMFILES\Polar Account Switcher"
...
;Interface Configuration
  ...
  !define MUI_HEADERIMAGE_UNBITMAP "${INSTALLER_HEADER_BMP}"
  !define MUI_HEADERIMAGE_BITMAP_STRETCH AspectFitHeight
  !define MUI_HEADERIMAGE_UNBITMAP_STRETCH AspectFitHeight
  !define MUI_ABORTWARNING

  !define MUI_WELCOMEFINISHPAGE_BITMAP "${INSTALLER_SIDEBANNER_BMP}"
  !define MUI_WELCOMEFINISHPAGE_BITMAP_NOSTRETCH
  !define MUI_UNWELCOMEFINISHPAGE_BITMAP "${INSTALLER_SIDEBANNER_BMP}"
...
;Pages
  ...
  !define MUI_FINISHPAGE_LINK "https://discord.gg/PLR"
  !define MUI_FINISHPAGE_LINK_LOCATION "https://discord.gg/PLR"
...
Section "Main files" InstSec
  ...
  !if "${USE_NSIS7Z}" == "1"
    ...
    File "${INSTALLER_7Z}"
    SetCompress auto
    Nsis7z::ExtractWithDetails "$INSTDIR\PolarWolves.7z" "Decompressing %s..."
    Delete "$OUTDIR\PolarWolves.7z"
  !else
  ...
  ;Create protocol
  WriteRegStr HKCR "polarwolves" "URL Protocol" ""
  WriteRegStr HKCR "polarwolves\Shell\Open\Command\" "" `"$INSTDIR\${MAIN_APP_EXE}" "%1"`
  ...
  IfFileExists "$INSTDIR\${FIRST_RUN_EXE}" 0 +2
