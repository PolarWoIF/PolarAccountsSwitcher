...
async function uploadFiles() {
  try {
    await uploadDirectory(
      "PolarWolves-Client\\bin\\x64\\Release\\PolarWolves",
    ...
    // Upload Hashes
    await uploadFile(
      'PolarWolves-Client\\bin\\x64\\Release\\UpdateOutput\\hashes.json',
    ...
    await uploadFile(
      'PolarWolves-Client\\bin\\x64\\Release\\UpdateDiff.7z',
