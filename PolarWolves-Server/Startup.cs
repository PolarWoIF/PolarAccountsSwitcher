...
namespace PolarWolves_Server
{
    public class Startup
    {
        ...
        [
            @"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\PolarWolves",
            @"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\PolarWolves"
        ];
        ...
        public static void UpdateRegistryVersion(string version)
        {
            ...
            string uninstallExePath = Path.Combine(exeDirectory, "Uninstall PolarWolves.exe");
