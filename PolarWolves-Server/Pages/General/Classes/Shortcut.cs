...
namespace PolarWolves_Server.Pages.General.Classes
{
...
#pragma warning disable CA2211 // Non-constant fields should not be visible
        ...
        public static string StartMenu = Path.Join(Environment.GetFolderPath(Environment.SpecialFolder.Programs), @"PolarWolves\");
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        /// <summary>
        /// Fills in necessary info to create a shortcut to the PolarWolves
        /// </summary>
        ...
        public Shortcut Shortcut_Switcher(string location)
        {
            ...
            ShortcutPath = Path.Join(location, "PolarWolves.lnk");
            Desc = "PolarWolves";
            Args = "";
            return this;
        }
        ...
        public Shortcut Shortcut_Tray(string location)
        {
            ...
            Exe = Path.Join(ParentDirectory(GetSelfPath()), "PolarWolves-Tray.exe");
            WorkingDir = Directory.GetCurrentDirectory();
            IconDir = Path.Join(WorkingDir, "wwwroot\\prog_icons\\program.ico");
            ShortcutPath = Path.Join(location, "PolarWolves - Tray.lnk");
            Desc = "PolarWolves - Tray";
            Args = "";
            return this;
        }
        ...
        /// <param name="descAdd">(Optional) Additional description to add to "PolarWolves - Steam</param>
        ...
        public Shortcut Shortcut_Platform(string location, string platformName = "Steam", string args = "steam", string descAdd = "", bool platformNameIsFullName = false)
        {
            ...
            ShortcutPath = Path.Join(location, (platformNameIsFullName ? platformName : $"{platformName} - PolarWolves") + ".lnk");
            Desc = $"PolarWolves - {platformName}" + descAdd != "" ? descAdd : "";
            Args = args;
            return this;
        }
        #endregion
        ...
        public static bool CheckShortcuts(string platform)
        {
            ...
            return File.Exists(Path.Join(Desktop, $"{platform} - PolarWolves.lnk"));
        }
        ...
        /// <summary>
        /// Checks if the PolarWolves Tray application has a Task to start with Windows
        /// </summary>
        public static bool StartWithWindows_Enabled() => File.Exists(Path.Join(Environment.GetFolderPath(Environment.SpecialFolder.Startup), "PolarWolves - Tray.lnk"));

        /// <summary>
        /// Toggles whether the PolarWolves Tray application starts with Windows or not
        /// </summary>
