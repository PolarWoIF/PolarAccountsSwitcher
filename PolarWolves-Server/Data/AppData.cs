...
using Index = PolarWolves_Server.Pages.Steam.Index;
...
namespace PolarWolves_Server.Data
{
    public class AppData
    {
        ...
        // Window stuff
        private string _windowTitle = "PolarWolves";
        ...
        [JsonIgnore] public static bool PolarWolvesClientApp { get => Instance._tcNoClientApp; set => Instance._tcNoClientApp = value; }
