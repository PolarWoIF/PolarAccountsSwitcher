...
using PolarWolves_Tray.Properties;

namespace PolarWolves_Tray
{
    ...
    {
        private readonly string _mainProgram = Path.Join(Path.GetDirectoryName(Process.GetCurrentProcess().MainModule?.FileName)!, "PolarWolves_main.exe");
        ...
        private static bool AlreadyRunning() => Process.GetProcessesByName("PolarWolves_main").Length > 0;
