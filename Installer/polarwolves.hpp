...
inline void download_install_missing_runtimes()
{
	...
	cout << " - Windows Desktop Runtime 9.0+" << endl <<
		...
		"------------------------------------------------------------------------" << endl << endl <<
		"That should be everything. The main program, PolarWolves.exe, will auto-run." << endl << endl <<
		"If it doesn't work, please refer to install instructions, here:" << endl <<
		"https://discord.gg/PLR#required-runtimes-download-and-install" << endl << endl;
}
