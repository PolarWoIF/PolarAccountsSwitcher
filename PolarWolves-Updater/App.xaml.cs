    ...
    public partial class App
    {
        ...
        private static void IsRunningAlready()
        {
            try
            {
                ...
                _ = MessageBox.Show("Another PolarWolves Updater instance has been detected.");
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            for (var i = 0; i != e.Args.Length; ++i)
            {
                ...
                {
                    case "downloadcef":
                        PolarWolves_Updater.MainWindow.DownloadCef = true;
                        break;
                    case "verify":
                        PolarWolves_Updater.MainWindow.VerifyAndClose = true;
                        break;
                    case "hashlist":
                        PolarWolves_Updater.MainWindow.QueueHashList = true;
                        break;
                    case "createupdate":
                        PolarWolves_Updater.MainWindow.QueueCreateUpdate = true;
                        break;
                    default:
