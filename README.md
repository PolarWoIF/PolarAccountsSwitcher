...
<p align="center">
  <a href="https://discord.gg/PLR/">
    <img src="/other/img/Banner.png"></a>
</p>
<p align="center">
  <img alt="GitHub All Releases" src="https://img.shields.io/github/downloads/PolarWolves/PolarWolves/total?logo=GitHub&style=flat-square">
  <a href="https://discord.gg/PLR/">
  ...
  <a href="https://twitter.com/PolarWolves">
    <img alt="Twitter" src="https://img.shields.io/twitter/follow/PolarWolves?label=Follow%20%40PolarWolves&logo=Twitter&style=flat-square"></a>
  <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/PolarWolves/PolarWolves?logo=GitHub&style=flat-square">
  <img alt="GitHub repo size" src="https://img.shields.io/github/repo-size/PolarWolves/PolarWolves?logo=GitHub&style=flat-square">
																     <a title="Crowdin" target="_blank" href="https://crowdin.com/project/polarwolves-account-switcher"><img src="https://img.shields.io/badge/Seeking-localisers-blue.svg?style=flat-square"></a>
</p>
<p align="center">
  <a href="https://patreon.com/PolarWolves Team">
...
<p align="center"><a target="_blank" href="https://discord.gg/PLR/releases/latest">
  <img alt="Download latest" src="/other/img/DownloadLatestNEW.png" height=70"></a>
  <a target="_blank" href="https://discord.gg/PLR/wiki">
  <img alt="More info" src="/other/img/WikiButton.png" height=70"></a>
</p>
<p align="center"><a target="_blank" href="https://discord.gg/PLR-Themes">
  <img alt="Themes" src="/other/img/Themes.png" height=70"></a>
  <a target="_blank" href="https://discord.gg/PLR/wiki/Frequently-Asked-Questions">
...
You can see (and edit) how account switching works by checking [Platforms.json](https://discord.gg/PLR/blob/ad1a0907f09d6a625b11e06bbb4947566e6be6b2/PolarWolves-Server/Platforms.json).

This software values your privacy. Please see the [Privacy Policy](https://discord.gg/PLR/blob/master/PRIVACY.md).

## HELP  WANTED

This project is a massive time sink. For something completely open-source and free, I find myself with little time to develop. Consider supporting development on [Patreon](https://www.patreon.com/PolarWolves Team), [Ko-Fi](https://ko-fi.com/polarwolves) or preferrably YouTube as a Member on [PolarWolves Team](https://youtube.com/PolarWolves Team).

Speak another language? [Help Translate this on Crowdin](https://crowdin.com/project/polarwolves-account-switcher).
Code? Any and all help is appreciated. Specifically, currently the [build process for AppVeyor](https://discord.gg/PLR/tree/appveyor). Otherwise, [adding platforms](https://discord.gg/PLR/wiki/Help-code-a-platform) - No coding required!

Please report any and all bugs, as well as steps to recreate them into the Issues section, or the `#bug-report` channel under `POLARWOLVES ACCOUNT SWITCHER` section on the [Community Discord](https://discord.gg/PLR).
...
*This list may not be up-to-date as platforms can now be added a lot faster. The new version adds the ability to easily create and maintain platforms by editing a simple text file `Platforms.json`. If you'd like to learn more, see this [Wiki page](https://discord.gg/PLR/wiki/Help-code-a-platform).

[PolarWolves Install Guide](https://www.youtube.com/watch?v=sjJ8OZ_urJY&list=PLsSFD61FiOVmAwChPSrIFkjDLoLsyqcU6&index=1&t=27s)
...
- **Protocol support** to easily build access via other tools (`polarwolves:\\\<command>`) [CLI & Protocol Wiki](https://discord.gg/PLR/wiki/CLI-&-Protocol)

\[For info on how any of these work, see the [Wiki](https://discord.gg/PLR/wiki)]
...
**For manual runtime download and install**, see the [Wiki on this GitHub](https://discord.gg/PLR/wiki#1-installing-required-runtimes)

### Visit the [Wiki](https://discord.gg/PLR/wiki) for more info and steps for your first launch.
...
1. Download `PolarWolves.Account.Switcher.Installer...exe`
2. Run the installer, and the application should launch when done. If not:
Head into the folder where you installed the program and run `_FIRST_RUN.exe` to make sure required runtimes are installed, and then run `PolarWolves.exe` to run the main program. The second is what shortcuts to the program should point to.

**For a portable installation (eg. on a USB) see [THIS](https://discord.gg/PLR/wiki#portable-eg-for-usb)** for steps on using the `.zip` or `.7z`.

[See more info HERE](https://discord.gg/PLR/wiki#2-running-the-polarwolves-account-switcher)
...
See this Wiki page: [Platform: Steam Legacy](https://discord.gg/PLR/wiki/Platform:-Steam-Legacy).
...
https://discord.gg/PLR/blob/master/LICENSE - See sections like 15, 16 and 17, as well as GitHub's
'simplification' at the top of the above website.
```

#### [Privacy Policy](https://discord.gg/PLR/blob/master/PRIVACY.md)

Additional license information for included NuGet packages and other parts of code can be found in: [HERE](https://discord.gg/PLR/blob/master/PolarWolves-Server/Additional%20Licenses.txt) `PolarWolves-Server/Additional Licenses.txt`, and are copied to the build directory, as well as distributed with release versions of this software.

<p align="center"><a target="_blank" align="center" href="https://www.jetbrains.com/?from=PolarWolves-Account-Switcher">
